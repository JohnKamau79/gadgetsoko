                    ...
                    @forelse ($retailerOrders as $order)
                        @foreach ($order->orderItems as $item)
                            <tr class="border-b bg-white dark:bg-gray-900 hover:bg-teal-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="p-3 text-gray-800 dark:text-gray-100">{{ $order->user->firstName }}</td>
                                <td class="p-3 text-gray-800 dark:text-gray-100">{{ $item->product->title ?? 'Product Deleted' }}</td>
