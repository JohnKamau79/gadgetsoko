...
@section('adminDashboardContent')
    ...
    <div class="p-6">
        <h1 class="text-3xl font-bold mb-6 text-teal-600 dark:text-teal-400">Website Reviews Management</h1>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-x-auto">
            <table class="min-w-full border-collapse">
                ...
                <tbody>
                    @forelse ($adminWebsiteReviews as $review)
                        <tr class="border-b bg-white dark:bg-gray-900 hover:bg-teal-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="p-3 text-gray-800 dark:text-gray-100">{{ $review->user->email ?? 'N/A' }}</td>
                            <td class="p-3 text-gray-800 dark:text-gray-100">{{ $review->rating }}/5</td>
                            <td class="p-3 text-gray-800 dark:text-gray-100">{{ $review->review }}</td>
