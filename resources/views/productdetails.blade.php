...
@section('content')
    ...
    @if (auth()->check())
        <form method="POST" action="{{ route('productReview.store', $product->id) }}"
            class="mt-6 flex flex-col w-1/2 border border-gray-300 p-2 rounded-md bg-white justify-center ml-12 pl-8">
            @csrf
