        ...
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start">
            ...
            <div class="bg-gray-50 p-8 rounded-xl shadow">
                ...
                <form action="{{ route('contact.submit') }}" method="POST" class="space-y-4">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-500 transition">Send
                        Message</button>
                </form>
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <img src="https://via.placeholder.com/400x200?text=Map+Placeholder" alt="Map"
